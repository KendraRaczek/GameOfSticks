...
//		 testTrainAi();
	 ...
	 * 1. When there are 0 sticks remaining, this tests to make sure the computer returns 0 for the amount of sticks it takes.
	 * 2. Tests to make sure the number of sticks remaining doesn't end up negative by preventing the computer from taking any more sticks.
	 * 3. Tests to make sure the computer won't make itself lose when there are 2 sticks remaining.
	 * 4. Checks to make sure that the computer takes a number of sticks that is between the maximum and minimum bounds.
	 * 5. Test the random number generator to make sure it's working as expected.
	 */
